...
public class AlertCheckOfCar extends TestListeners
{
	public AlertCheckOfCar(WebDriver driver)
	{
	...
	public void MandatoryAlertOfCar() throws Exception
	{
		...
		CommonMethods.input("Firstname_XPATH", "MandatoryAlert", "First Name", 1);
		CommonMethods.input("Lastname_XPATH", "MandatoryAlert", "Last Name", 1);
		CommonMethods.input("MobNo_XPATH", "MandatoryAlert", "Mobile No", 1);
		CommonMethods.input("CRNNo_XPATH", "MandatoryAlert", "CRN No", 1);
		Thread.sleep(2000);
		CommonMethods.mouseClick("Product_XPATH");
		CommonMethods.selectByText("Product_XPATH", "MandatoryAlert", "Product for Car", 1);
		Thread.sleep(5000);
		...
		CommonMethods.selectByText("NotInterestedReasonForCar_xpath", "MandatoryAlert", "Not Interested Reason", 1);
	...
	/*	try {
		...
		CommonMethods.Click("CrossBar_XPATH");
		CommonMethods.input("CoreCRN_XPATH", "MandatoryAlert", "Core CRN", 1);
		Thread.sleep(1000);
		CommonMethods.mouseClick("SaveAndProceed_XPATH");
		Thread.sleep(1000);    */
		CommonMethods.scrollAtBottom();
	...
	public void ValidationAlertOnCar() throws Exception
	{
		...
		ScreenShot.takeSnapShot("screenshot for alert of Validation rule 1", "Pass");
			...
			Thread.sleep(1000);
			CommonMethods.mouseClick("Product_XPATH");
			CommonMethods.selectByText("Product_XPATH", "ValidationAlert", "Product for Car", 1);
			Thread.sleep(1000);
