...
public class KMBClearScriptODC_Adhoc extends TestListeners 
{
public static Logger  log =(Logger) LogManager.getLogger(WCDL_ADHOC_OfferJourney.class.getName());
	...
	public void ClearOffer() throws Exception
	{
		...
		Thread.sleep(2000);
		CommonMethods.input("CRN_text_Box_XPATH", "WCDLOffer_forAdhoc", "CRN of individual", 1);
		Thread.sleep(2000);
		...
		CRN_txtbox.clear();
		Thread.sleep(4000);
		CommonMethods.input("CRN_text_Box_XPATH", "WCDLOffer_forAdhoc", "CRN of borrowing entity", 1);
		Thread.sleep(4000);
		CommonMethods.mouseClick("Fetch_Button_XPATH");
		Thread.sleep(4000);
		CommonMethods.mouseClick("ReFetch_Button_XPATH");
		...
		CommonMethods.input("Offer_Id_text_Box_XPATH", "WCDLOffer_forAdhoc", "Offer Id", 1);
		Thread.sleep(5000);
		CommonMethods.mouseClick("Fetch_Button_XPATH");
		
		CommonMethods.switchToWindowByTitle(WCDL_ADHOC_OfferJourney.Title1);
