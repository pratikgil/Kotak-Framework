...
public class LeadSearchPageCC_WithDoc extends TestListeners 
{
	public static String WindowId;
	public static String OTPVerification;
	GetOTPCC_WithDoc GOC = new GetOTPCC_WithDoc();

	public static Logger log =(Logger) LogManager.getLogger(LeadSearchPageCC_WithDoc.class.getName());
	...
	public void LeadSearch1() throws Exception
	{
		...
		CommonMethods.input("LeadIdCC_XPATH", "NTBAssistedJourneyWithDocCC", "ReferanceNo", 1);
	...
	public void Leadsearch2() throws Exception
	{
		...
		CommonMethods.input("6DigitOTPCC_XPATH","NTBAssistedJourneyWithDocCC", "OTP", 1);
